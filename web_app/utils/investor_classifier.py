...
INVESTOR_QUESTIONS = [
    {
        "id": "Q1",
        "question": "단기 수익보다는 꾸준한 장기 수익을 목표로 투자하는 편이다.",
        "type": "MIRAE"
    },
    {
        "id": "Q2",
        "question": "손실이 나면 빠르게 매도하고 싶어진다.",
        "type": "ASAP"
    },
    {
        "id": "Q3",
        "question": "기업의 실적이나 재무제표 같은 공신력 있는 데이터를 중요하게 생각한다.",
        "type": "MIRAE"
    },
    {
        "id": "Q4",
        "question": "SNS 반응은 투자 판단에 중요한 기준이 된다.",
        "type": "ASAP"
    },
    {
        "id": "Q5",
        "question": "매수 후에는 주가를 자주 확인하지 않고, 여유 있게 기다리는 편이다.",
        "type": "MIRAE"
    },
    {
        "id": "Q6",
        "question": "뉴스보다 SNS에서 먼저 투자 관련 이슈를 확인하는 편이다.",
        "type": "ASAP"
    }
]
