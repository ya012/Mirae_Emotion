...
def get_fallback_summary(investor_type):
    """API 실패시 대체 요약"""
    if investor_type == "MIRAE":
        return """최근 밴드 그룹 데이식스(DAY6)의 10주년 기념 팬미팅에서 과도한 개인정보 확인 절차로 인한 논란이 일었습니다. 이로 인해 많은 팬들이 불편을 겪었으며, 일부는 입장을 거부당하기도 했습니다. 이러한 상황에 대해 JYP엔터테인먼트는 공식적으로 사과했으며, 부당한 개인정보 요구 사실을 인정하고 이에 대한 책임을 통감한다고 밝혔습니다. 또한, 과도하게 본인 확인 절차를 진행한 결과 입장에 실패한 관객들에게 티켓 환불을 약속하며, 향후 보상 절차에 관한 상세한 공지를 제공하겠다고 전했습니다. JYP는 앞으로 유사한 문제가 재발하지 않도록 철저한 관리를 다짐하면서, 남은 팬미팅 기간 동안 모든 관객들이 즐겁게 참여할 수 있도록 노력하겠다는 의지를 표명했습니다. 이러한 사건은 팬들과의 신뢰 회복뿐만 아니라 회사의 이미지 관리 측면에서도 중요한 과제가 될 것으로 보입니다. 따라서 투자자들은 이와 같은 고객 경험 이슈가 기업의 평판에 미칠 영향을 주의 깊게 살펴볼 필요가 있습니다. 특히, 엔터테인먼트 산업에서의 고객 만족도는 매우 중요하므로, JYP의 신속한 대처와 개선 노력이 향후 실적에도 긍정적인 영향을 미칠 가능성이 큽니다."""
